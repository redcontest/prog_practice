...
Программа определяет, находится ли участник олимпиады в тройке
победителей.

Основные возможности:
- Фильтрация неверных данных (программа будет добиваться
  корректного введения)
- Программа сообщает пользователю, находится ли он в тройке
  победителей
- Программа учитывает, что двух участников с одинаковыми баллами
  нельзя справедливо разместить друг за другом, поэтому анализ
  проводится на основе принципа "одинаковые баллы - одинаковое
  призовое место"
"""
